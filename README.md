...
Extract the rxTools folder from the release and place it into the rood of your card
...
For use with the Homebrew Launcher, go into the ninjhax folder and copy the /rxTools folder into SD:/3ds/
