...
Just run **make release** and rxTools/sys directory should be generated in the **release** folder, along with all the other packets. Add firm folder (run tools/cdn_firm.py to download it) to release/rxTools/, then copy the contents of the release folder to the root of your SD card.  
