...
#define CTR_FCRAM_ADDR_MAX 0x24000000
#define KTR_FCRAM_ADDR_MAX 0x27B00000

#ifdef PLATFORM_KTR
#define ARM9_VRAM_ADDR KTR_ARM9_VRAM_ADDR
#define FCRAM_ADDR_MAX KTR_FCRAM_ADDR_MAX
#else
#define ARM9_VRAM_ADDR CTR_ARM9_VRAM_ADDR
#define FCRAM_ADDR_MAX CTR_FCRAM_ADDR_MAX
#endif
